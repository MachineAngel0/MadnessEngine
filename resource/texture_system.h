...
MAPI bool texture_system_load_font(Asset_System* asset_system, const char* file_path, Texture_Handle* out_handle, Allocator* arena);
MAPI bool texture_system_unload_font(Asset_System* asset_system, Texture_Handle handle);
MAPI bool texture_system_get_font(Texture_System* texture_system, Texture_Handle handle, Madness_Font* out_font);



MAPI bool texture_system_load_msdf_font(Asset_System* asset_system, const char* file_path, Texture_Handle* out_handle, Frame_Allocator* frame_arena);
