...
void mesh_system_load_skinned_mesh(Asset_System* asset_system, Madness_SkMesh_Runtime* skmesh_asset, u64 hash, String* engine_path, MADNESS_UUID uuid);

bool mesh_system_exists_mesh(Asset_System* asset_system, Madness_Mesh_Handle* out_handle, u64 hash);
bool mesh_system_exists_skmesh(Asset_System* asset_system, Madness_SkMesh_Handle* out_handle, u64 hash);
