...
{
    Vulkan_Texture_System* system = renderer->texture_system;
    ...
    while (!ring_queue_is_empty(packet->texture_upload_queue) && current_upload_count < frame_upload_budget)
    {
        ...
        texture_upload.madness_texture->bindless_slot_external = texture_upload.madness_texture->bindless_slot;
