...
void vulkan_swapchain_create(Renderer* renderer, u32 width, u32 height, Vulkan_Swapchain* swapchain_out);

void vulkan_swapchain_destroy(Renderer* renderer, Vulkan_Swapchain* swapchain);

void vulkan_swapchain_recreate(Renderer* renderer, u32 width, u32 height, Vulkan_Swapchain* swapchain);
