...
MAPI void material_renderer_upload_data(Renderer* renderer, Material_Renderer* material_renderer, Render_Packet* render_packet, vulkan_command_buffer* command_buffer);
