...
bool vulkan_textured_shader_create(vulkan_context* context, vulkan_shader_texture* textured_shader)
{
    ...
    */
    ...
    attributeDescriptions[0].location = 0;
    attributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;
    // attributeDescriptions[0].offset = offsetof(vertex_tex, position); //offsetof is pretty interesting
    attributeDescriptions[0].offset = offsetof(vertex_tex, position); //offsetof is pretty interesting
    ...
    attributeDescriptions[1].location = 1;
    attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
    // attributeDescriptions[1].offset = offsetof(vertex_tex, color); //offsetof is pretty interesting
    attributeDescriptions[1].offset = offsetof(vertex_tex, color); //offsetof is pretty interesting
    ...
    // attributeDescriptions[2].offset = offsetof(vertex_tex, texture);
    attributeDescriptions[2].offset = offsetof(vertex_tex, texture);
    ...
    * if (blendEnable) {
    ...
    VkResult graphics_result = vkCreateGraphicsPipelines(context->device.logical_device, VK_NULL_HANDLE, 1,
                                                         &graphics_pipeline_info, NULL, &textured_shader->shader_texture_pipeline.handle);
