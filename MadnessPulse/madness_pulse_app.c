...
bool madness_pulse_run(Madness_Pulse_Application* madness_pulse_app)
{
   ...
   DEBUG("RELEASE MODE")
    ...
    texture_system_load_texture_engine(application_core->asset_system, "test_particle");
    ...
    // mesh_load_gltf(application_core->asset_system, "../z_assets/models/MC/MC4.2_6.gltf");*/
