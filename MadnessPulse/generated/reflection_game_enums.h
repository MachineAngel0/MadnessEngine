...
void generate_runtime_enums_madness_pulse_game(Reflection_Registry* reflection_registry)
{
	...
	const Reflection_Runtime_Enum Ability_Target_Area_enum =
	{
	...
	const Reflection_Runtime_Enum Ability_Component_Target_Type_enum =
	{
	...
	const Reflection_Runtime_Enum AI_Consideration_Type_enum =
	{
	...
	const Reflection_Runtime_Enum AI_Target_Type_enum =
	{
		.name = "AI_Target_Type",
	...
	const Reflection_Runtime_Enum AI_MultiTarget_Health_Bias_enum =
	{
	...
	const Reflection_Runtime_Enum AI_Consideration_Sign_enum =
	{
	...
	const Reflection_Runtime_Enum Consideration_Choice_Type_enum =
	{
