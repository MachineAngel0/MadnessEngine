...
void ability_component_process_effect(Unit* unit, Ability_Component* ability_data)
{
    ...
    case Ability_Component_TYPE_CHARGE:
        charge_ability(unit, &ability_data->data.charge);
        break;

    case Ability_Component_TYPE_ABILITY_ADDER:
        ability_adder_ability(unit, &ability_data->data.ability_add);
        break;
    case Ability_Component_TYPE_ABILITY_REMOVER:
        ability_remover_ability(unit, &ability_data->data.ability_remove);
        break;
    case Ability_Component_TYPE_ABILITY_REMOVE_ALL:
        ability_remove_all_ability(unit, &ability_data->data.ability_remove_all);
        break;

    case Ability_Component_TYPE_ACTION_ADD:
        action_add_ability(unit, &ability_data->data.action_add);
        break;
    case Ability_Component_TYPE_ACTION_REMOVE:
        action_remove_ability(unit, &ability_data->data.action_remove);
        break;
    ...
    case Ability_Component_TYPE_CONJURE:
        conjure_component_ability(unit, &ability_data->data.conjure);
        break;
    case Ability_Component_TYPE_SUMMONER:
        //TODO:
        // summoner_component_ability(unit, &ability_data->data.summoner);
        break;
