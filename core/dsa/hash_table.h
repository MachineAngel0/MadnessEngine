...
#define HT_STRING_DEFAULT_CAPACITY 100
#define HT_STRING_TEST_CAPACITY 100
...
#define HASH_TABLE_CREATE_DEFAULT_SIZE(type) _hash_table_create(sizeof(type), HT_STRING_TEST_CAPACITY)
